...
// 반복적으로 보이기 쉬운 짧은 후보군을 추가 확장한다.
// 아래 문장들도 오행의 생활 의미 안에서만 구성하고, 최종 선택은 사주 태그 점수로 정한다.
const OHAENG_EXTRA_OPTIONS = {
  목: {
    timeOptions: [
      { range:'평일 이른 저녁', detail:'퇴근 뒤 짧은 산책이나 새 장소 방문으로 일상에 작은 변화를 주기 좋아요.' },
      { range:'비가 그친 다음 날 오전', detail:'공기가 맑은 야외에서 걸으며 다음 계획을 가볍게 꺼내기 좋아요.' },
      { range:'여행 첫날 오전', detail:'새로운 장소를 함께 탐색하며 자연스럽게 역할을 나누기 좋아요.' },
      { range:'한 달의 첫 주말', detail:'이번 달 함께 해볼 일을 정하고 바로 첫걸음을 떼기 좋아요.' },
    ],
    keywords:['둘만의 새 루틴','함께 넓히는 취향','작은 도전의 시작','다음 장면을 만드는 행동'],
    summaryPool:[
      '한 사람이 제안하고 다른 사람이 바로 첫 행동을 보태는 모습',
      '서로의 망설임을 줄여 작게라도 시작해보는 분위기',
      '걷고 움직이며 대화가 자연스럽게 열리는 관계',
      '새 경험을 통해 서로 몰랐던 취향을 발견하는 과정',
      '계획을 말로만 두지 않고 날짜와 장소까지 정하는 습관',
      '서로의 목표에 현실적인 첫걸음을 보태주는 모습',
    ],
  },
  화: {
    timeOptions: [
      { range:'금요일 저녁', detail:'한 주 동안 쌓인 이야기를 나누고 밝은 분위기로 전환하기 좋아요.' },
      { range:'노을이 시작되기 30분 전', detail:'산책과 사진, 식사를 자연스럽게 이어가며 설렘을 표현하기 좋아요.' },
      { range:'공연이나 경기 직후', detail:'함께 느낀 감정을 바로 이야기하며 친밀감을 높이기 좋아요.' },
      { range:'기분 좋은 소식이 있던 날', detail:'서로의 기쁨을 크게 반응해주고 작은 축하를 만들기 좋아요.' },
    ],
    keywords:['표현으로 확인하는 사랑','둘만의 밝은 기억','반응을 나누는 설렘','따뜻하게 드러내는 마음'],
    summaryPool:[
      '상대의 기쁜 일에 적극적으로 반응하며 애정을 확인하는 모습',
      '좋아한다는 마음을 미루지 않고 그날 바로 보여주는 분위기',
      '둘만의 사진과 농담을 쌓아 연인다운 기억을 만드는 과정',
      '평범한 만남도 작은 축하처럼 즐겁게 바꾸는 에너지',
      '서운함을 숨기기보다 부드럽고 솔직하게 말하는 습관',
      '서로의 매력을 자주 칭찬하며 관계의 온도를 유지하는 모습',
    ],
  },
  토: {
    timeOptions: [
      { range:'일요일 늦은 오전', detail:'서두르지 않고 식사와 산책을 이어가며 생활 리듬을 맞추기 좋아요.' },
      { range:'장보기 전후의 오후', detail:'함께 필요한 것을 고르고 식사를 준비하며 실제 생활 호흡을 보기 좋아요.' },
      { range:'긴 일정이 끝난 다음 날', detail:'새로운 자극보다 휴식과 돌봄을 우선하며 안정감을 회복하기 좋아요.' },
      { range:'월말의 여유로운 오후', detail:'다음 달 일정과 예산을 부담 없이 정리하기 좋아요.' },
    ],
    keywords:['함께 지키는 생활 리듬','말보다 꾸준한 돌봄','편안하게 기대는 관계','현실적인 신뢰'],
    summaryPool:[
      '바쁜 날에도 식사와 안부를 챙겨 관계의 중심을 잡는 모습',
      '한 번 정한 약속을 꾸준히 지켜 믿음을 보여주는 분위기',
      '둘의 생활 속 불편을 실제 행동으로 하나씩 줄여가는 과정',
      '힘든 날에는 새로운 해결책보다 먼저 쉬게 해주는 배려',
      '돈과 시간을 무리 없이 나누며 안정적인 연애를 만드는 습관',
      '같은 공간에서 각자 쉬어도 편안한 생활형 친밀감',
    ],
  },
  금: {
    timeOptions: [
      { range:'평일 퇴근 후 이른 저녁', detail:'붐비기 전에 예약한 공간에서 서로에게 집중하기 좋아요.' },
      { range:'월초의 저녁', detail:'이번 달 일정과 꼭 지키고 싶은 약속을 함께 정하기 좋아요.' },
      { range:'중요한 결정을 앞둔 오후', detail:'감정이 지치기 전에 조건과 우선순위를 차분히 정리하기 좋아요.' },
      { range:'전시 마지막 입장 전', detail:'정돈된 공간을 함께 보고 식사하며 생각을 명확하게 나누기 좋아요.' },
    ],
    keywords:['확인하고 지키는 마음','서로의 선을 존중하는 사랑','정확하게 나누는 기대','함께 완성하는 약속'],
    summaryPool:[
      '애매한 기대를 추측하지 않고 서로 원하는 것을 확인하는 모습',
      '거절과 개인 시간을 존중하며 건강한 거리를 지키는 분위기',
      '둘의 약속을 기록하고 실제로 끝까지 지켜내는 과정',
      '문제가 생겼을 때 감정과 해결할 일을 나누어 말하는 습관',
      '서로의 취향을 세심하게 관찰해 오래 쓸 선택을 해주는 모습',
      '분명한 표현과 예의를 함께 지켜 신뢰를 높이는 관계',
    ],
  },
  수: {
    timeOptions: [
      { range:'늦은 저녁 식사 후', detail:'하루의 긴장이 풀린 뒤 해결책보다 마음을 나누는 대화에 좋아요.' },
      { range:'눈이나 비가 오는 평일 저녁', detail:'조용한 실내에서 서로의 속도를 존중하며 오래 머물기 좋아요.' },
      { range:'여행 마지막 밤', detail:'함께한 경험을 돌아보고 서로에게 남은 감정을 차분히 말하기 좋아요.' },
      { range:'휴대폰을 내려놓은 30분', detail:'외부 자극 없이 상대의 말과 표정에 집중하기 좋아요.' },
    ],
    keywords:['침묵까지 편안한 사이','속도를 존중하는 친밀감','마음을 오래 듣는 사랑','둘만의 조용한 깊이'],
    summaryPool:[
      '대답을 재촉하지 않고 상대가 말을 마칠 때까지 기다려주는 모습',
      '조용한 시간 속에서 표정과 말투의 변화를 세심하게 살피는 분위기',
      '싸운 뒤 잠시 쉬더라도 다시 대화할 시간을 정확히 약속하는 습관',
      '둘만의 밤 산책과 긴 대화로 감정을 천천히 정리하는 과정',
      '각자의 혼자 있는 시간을 인정하면서도 필요한 순간에는 곁을 지키는 모습',
      '문제를 바로 고치려 하기보다 먼저 이해받았다는 느낌을 주는 관계',
    ],
  },
};

Object.entries(OHAENG_EXTRA_OPTIONS).forEach(([element, extra]) => {
  const info = OHAENG_INFO[element];
  if (!info) return;
  ['timeOptions','keywords','summaryPool'].forEach(key => {
    if (Array.isArray(extra[key])) info[key] = [...(info[key] || []), ...extra[key]];
  });
});
...
function addRecommendationWeight(weights, tag, value) {
  weights[tag] = (weights[tag] || 0) + value;
}

function buildRecommendationContextWeights(context, ohaeng) {
  const weights = {};
  const relation = context?.relation;
  if (relation === '상생') {
    addRecommendationWeight(weights,'trust',8); addRecommendationWeight(weights,'care',7);
    addRecommendationWeight(weights,'cooperation',6); addRecommendationWeight(weights,'comfort',4);
  } else if (relation === '상극') {
    addRecommendationWeight(weights,'attraction',7); addRecommendationWeight(weights,'communication',7);
    addRecommendationWeight(weights,'boundary',6); addRecommendationWeight(weights,'repair',6);
  } else if (relation === '동기') {
    addRecommendationWeight(weights,'shared',8); addRecommendationWeight(weights,'playful',7);
    addRecommendationWeight(weights,'familiar',6); addRecommendationWeight(weights,'activity',4);
  } else {
    addRecommendationWeight(weights,'calm',7); addRecommendationWeight(weights,'steady',7);
    addRecommendationWeight(weights,'gentle',5); addRecommendationWeight(weights,'routine',4);
  }

  const dayType = context?.dayJijiRelation?.type;
  ({
    육합: [['intimacy',9],['romantic',7],['comfort',6],['trust',5]],
    삼합: [['activity',8],['goal',7],['shared',6],['outdoor',4]],
    충: [['pacing',9],['boundary',8],['communication',7],['attraction',4]],
    형: [['repair',8],['gentle',7],['communication',5]],
    해: [['clarity',8],['boundary',7],['care',5]],
    동일: [['familiar',8],['playful',6],['routine',5]],
    평: [['steady',5],['gentle',4]],
  }[dayType] || []).forEach(([tag,value]) => addRecommendationWeight(weights,tag,value));

  const yearTone = context?.yearJijiRelation?.tone;
  if (yearTone === 'good') {
    addRecommendationWeight(weights,'outdoor',5); addRecommendationWeight(weights,'activity',5);
    addRecommendationWeight(weights,'social',4); addRecommendationWeight(weights,'shared',3);
  } else if (yearTone === 'clash' || yearTone === 'friction') {
    addRecommendationWeight(weights,'private',6); addRecommendationWeight(weights,'planned',5);
    addRecommendationWeight(weights,'quiet',5); addRecommendationWeight(weights,'clarity',4);
  }

  const complementCount = (context?.complement?.aFillsB?.length || 0) + (context?.complement?.bFillsA?.length || 0);
  if (complementCount >= 2) {
    addRecommendationWeight(weights,'cooperation',7); addRecommendationWeight(weights,'gratitude',6);
    addRecommendationWeight(weights,'care',5);
  } else if (complementCount === 1) {
    addRecommendationWeight(weights,'care',5); addRecommendationWeight(weights,'gratitude',5);
  } else {
    addRecommendationWeight(weights,'balance',6); addRecommendationWeight(weights,'planned',4);
  }

  const elementWeights = {
    목: [['novelty',9],['outdoor',7],['activity',7],['growth',6],['goal',4]],
    화: [['expressive',9],['romantic',7],['social',6],['activity',6],['attraction',5]],
    토: [['steady',9],['routine',7],['food',6],['rest',6],['care',5]],
    금: [['planned',9],['clarity',8],['culture',6],['goal',6],['boundary',5]],
    수: [['quiet',9],['deep',8],['rest',7],['private',6],['communication',5]],
  };
  (elementWeights[ohaeng] || []).forEach(([tag,value]) => addRecommendationWeight(weights,tag,value));
  (elementWeights[context?.maxOhaeng] || []).forEach(([tag,value]) => addRecommendationWeight(weights,tag,Math.max(2,value-4)));
  return weights;
}

const RECOMMENDATION_TEXT_TAG_RULES = [
  { tags:['outdoor','activity'], words:['산책','자전거','트레킹','공원','숲','해변','야외','드라이브','걷기','운동','축제','경기장','놀이공원','농원','캠핑'] },
  { tags:['novelty','growth'], words:['새로운','처음','새로','체험','배워','수업','도전','변화','시작','첫걸음','박람회','버킷리스트'] },
  { tags:['goal','planned','clarity'], words:['계획','예약','목표','기준','예산','정리','기록','마무리','선택','역할','캘린더','완료','약속'] },
  { tags:['expressive','social'], words:['표현','웃','공연','노래','음악','응원','사진','기념일','칭찬','고마','보고 싶','축하','밝은','반응'] },
  { tags:['romantic','attraction'], words:['노을','야경','둘만','향수','기념일','설렘','분위기','불꽃','로맨틱','커플 사진','해 질'] },
  { tags:['steady','routine'], words:['꾸준','일상','정기','단골','생활','안정','오래','루틴','매달','반복','지키'] },
  { tags:['food','care'], words:['식사','요리','브런치','맛집','베이킹','시장','간식','도시락','반찬','차 마시','챙겨'] },
  { tags:['rest','comfort'], words:['집에서','숙소','온천','찜질','쉬기','휴식','마사지','족욕','아무 일정','편안','회복'] },
  { tags:['culture','quiet'], words:['미술관','전시','클래식','공예','서점','북카페','건축','사진관','뮤지엄','도자기','디자인'] },
  { tags:['deep','communication'], words:['대화','이야기','속마음','질문','감정','들어주','말해','확인','고민','어린 시절'] },
  { tags:['quiet','private'], words:['조용','밤','심야','별','호숫가','수족관','구석자리','평일 저녁','사람이 적','휴대폰을 내려'] },
  { tags:['repair','communication'], words:['싸운','서운','사과','불편','해결','반복하지','감정이 가라앉','다시 이야기'] },
  { tags:['shared','playful','cooperation'], words:['함께','서로','팀','장난','보드게임','같이','번갈아','공동','나눠','둘의'] },
  { tags:['trust','gratitude','care'], words:['신뢰','믿','배려','응원','고마','도움','챙기','존중','든든'] },
  { tags:['gentle','pacing'], words:['천천히','차분','가볍게','여유','서두르지','작은','한 가지씩','조금'] },
  { tags:['boundary','clarity'], words:['거절','개인 시간','연락 빈도','선을','분명','정확','확답','원하는 행동'] },
];

function optionText(option) {
  if (option && typeof option === 'object') return `${option.range || ''} ${option.detail || ''}`.trim();
  return String(option || '');
}

function inferColorTags(text) {
  const value = String(text || '');
  const tags = [];
  if (/(연두|민트|세이지|피스타치오|크림|아이보리|라이트|연한|살구|복숭아|화이트)/.test(value)) tags.push('gentle','calm');
  if (/(딥|짙은|버건디|와인|남색|네이비|인디고|검은|먹색|차콜|포레스트)/.test(value)) tags.push('deep','private');
  if (/(빨간|주황|코랄|체리|주홍|라임|에메랄드|자주)/.test(value)) tags.push('expressive','activity');
  if (/(핑크|로즈|복숭아|살구|샴페인)/.test(value)) tags.push('romantic','care');
  if (/(금색|은색|그레이|백금|스틸|베이지|갈색|브라운|오트밀|카멜|모래)/.test(value)) tags.push('planned','steady');
  if (/(파란|블루|청록|아쿠아|인디고|군청|청회)/.test(value)) tags.push('calm','deep');
  return tags;
}

function inferRecommendationTags(option, kind) {
  const text = optionText(option);
  const tags = new Set();
  RECOMMENDATION_TEXT_TAG_RULES.forEach(rule => {
    if (rule.words.some(word => text.includes(word))) rule.tags.forEach(tag => tags.add(tag));
  });
  if (kind === 'color') inferColorTags(text).forEach(tag => tags.add(tag));
  if (kind === 'time') {
    if (/(오전|아침|이른)/.test(text)) { tags.add('activity'); tags.add('novelty'); }
    if (/(오후|주말)/.test(text)) { tags.add('shared'); tags.add('activity'); }
    if (/(저녁|밤|해 질|노을)/.test(text)) { tags.add('romantic'); tags.add('deep'); }
    if (/(비 오는|눈이나 비|휴일|약속이 없는)/.test(text)) { tags.add('rest'); tags.add('private'); }
  }
  return [...tags];
}

function scoreRecommendationOption(option, kind, weights, seed, index) {
  const tags = inferRecommendationTags(option, kind);
  let score = tags.reduce((sum,tag) => sum + (weights[tag] || 0), 0);
  // 실제 궁합 태그와 직접 맞는 항목 수를 우선하고, 해시는 동점 순서에만 사용한다.
  const directMatches = tags.filter(tag => (weights[tag] || 0) >= 6).length;
  score += directMatches * 8;
  const tie = stableHash(`${seed}|${kind}|${index}|${optionText(option)}`) / 4294967296;
  return { option, tags, score:score + tie };
}

function selectRecommendationOptions(pool, count, kind, weights, seed) {
  if (!Array.isArray(pool) || pool.length === 0) return [];
  const ranked = pool.map((option,index) => scoreRecommendationOption(option,kind,weights,seed,index))
    .sort((a,b) => b.score - a.score);
  const selected = [];
  const tagUse = {};
  for (const item of ranked) {
    const mainTag = item.tags
      .slice()
      .sort((a,b) => (weights[b] || 0) - (weights[a] || 0))[0] || 'other';
    if ((tagUse[mainTag] || 0) >= 2 && ranked.some(x => !selected.includes(x) && (tagUse[(x.tags[0] || 'other')] || 0) < 2)) continue;
    selected.push(item.option);
    tagUse[mainTag] = (tagUse[mainTag] || 0) + 1;
...
function buildRecommendationVariant(ohaeng, seed, context) {
  ...
  const complementSignature = [
    (context?.complement?.aFillsB || []).slice().sort().join(''),
    (context?.complement?.bFillsA || []).slice().sort().join(''),
  ].sort().join(':');
  const contextText = [
    context?.relation || '', context?.maxOhaeng || '',
    context?.yearJijiRelation?.type || '', context?.dayJijiRelation?.type || '',
    context?.variantRole || '', complementSignature,
  ].join('|');
  const selectionSeed = `${seed}|${ohaeng}|${contextText}`;
  const weights = buildRecommendationContextWeights(context,ohaeng);
  const time = selectRecommendationOptions(info.timeOptions,1,'time',weights,selectionSeed)[0];
  ...
  const colors = selectRecommendationOptions(info.colors,3,'color',weights,selectionSeed);
  const places = selectRecommendationOptions(OHAENG_LOCATION_OPTIONS[ohaeng] || [],4,'location',weights,selectionSeed);
  const dateIdeas = selectRecommendationOptions(info.places,3,'date',weights,selectionSeed);
  const keyword = selectRecommendationOptions(info.keywords,1,'keyword',weights,selectionSeed)[0] || info.keyword;
  const summary = selectRecommendationOptions(info.summaryPool,1,'summary',weights,selectionSeed)[0];
  const dateTip = selectRecommendationOptions(info.dateTips,1,'tip',weights,selectionSeed)[0];
  const strongestTags = Object.entries(weights).sort((a,b) => b[1]-a[1]).slice(0,6).map(([tag]) => tag);
  ...
  return {
    ...
    selectionMethod: 'saju-tag-score',
    selectionBasis: strongestTags,
    variantId: stableHash(selectionSeed).toString(36),
  };
}
